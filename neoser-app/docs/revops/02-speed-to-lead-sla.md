...
|--------|--------------|----------------|-----------|
| Meta Ads (formulario) | < 5 min | Auto: email + tarea inmediata Diana | CRITICA |
| Google Ads | < 5 min | Auto: email + tarea inmediata Diana | CRITICA |
...
| Tasa de conversión "Contactada" a "Inscrita" | > 15% | Pipeline report |
