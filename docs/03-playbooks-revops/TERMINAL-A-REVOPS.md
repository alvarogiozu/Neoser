...
>
> **Nota de reorganización (2026-05-01):** este archivo se movió a `docs/03-playbooks-revops/TERMINAL-A-REVOPS.md` (antes vivía en `neoser-app/docs/revops/`). Las rutas vigentes de los playbooks 01-07 son `docs/03-playbooks-revops/0X-*.md` (no `neoser-app/docs/revops/...`). Los logs históricos abajo se preservan tal cual por trazabilidad.
